...
if game.CoreGui:FindFirstChild('OnyxUILib') then
    game.CoreGui:FindFirstChild('OnyxUILib'):Destroy()
    destroyed = true
end
...
local OnyxUILib = Instance.new("ScreenGui")

OnyxUILib.Name = "OnyxUILib"

protect_gui(OnyxUILib)
...
function library:Hide()
   OnyxUILib.Enabled = not OnyxUILib.Enabled
end	
...
function library:Window(name) 
    ...
    UiWindow.Parent = OnyxUILib
    UiWindow.BackgroundColor3 = Color3.fromRGB(99, 255, 112)
